...
This reference describes the complete `rulegate.yaml` format supported by
RuleGate 1.0.
...
are informational and may evolve without changing those machine contracts.
